...
const TechStackSlider = () => {
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          className="w-8 h-8 fill-white"
        >
          <path d="M480 32H32C14.3 32 0 46.3 0 64v384c0 17.7 14.3 32 32 32h448c17.7 0 32-14.3 32-32V64c0-17.7-14.3-32-32-32zM232 374.4v-52.9h-52.9v52.9h52.9zm157.1 0h-88.2L242.3 321c-5-5.3-7.7-12.3-7.7-19.6v-88.2c0-15.3 12.4-27.7 27.7-27.7h88.2c15.3 0 27.7 12.4 27.7 27.7v88.2c0 7.3-2.7 14.3-7.7 19.6l-58.6 53.4h77.2v-35.6h35.6v35.6z" />
        </svg>
      ),
    },
    {
  ...
  return (
    <div className="w-full relative flex flex-col gap-4 overflow-hidden py-4 bg-gray-900">
      <motion.div
        // animate={{
        //   x: [0, -1920],
        // }}
